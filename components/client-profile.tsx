        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          ...
          <div className="bg-white p-6 rounded-xl flex flex-col items-center w-4xs">
            ...
            <div className="flex gap-2 mt-2">
              <span className="px-3 py-1 bg-green-100 text-green-700 text-xs rounded-full border border-green-700">
                {clientData.status}
              </span>
              <span className="px-3 py-1 bg-purple-100 text-purple-700 text-xs rounded-full border border-purple-700">
              ...
              <div className="px-3 py-1 mt-5 bg-red-100 text-[#D61E1E] font-semibold text-sm rounded-full flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" className="bi bi-exclamation-circle fill-red-600" viewBox="0 0 16 16">
