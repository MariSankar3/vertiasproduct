            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[#eaecf0]">
                  ...
                  <th className="text-left p-4 text-xs font-semibold text-[#101828] uppercase tracking-wider">Stock Name</th>
                  <th className="text-left p-4 text-xs font-semibold text-[#101828] uppercase tracking-wider">Versions</th>
                  <th className="text-left p-4 text-xs font-semibold text-[#101828] uppercase tracking-wider">
                    Entry Price
                  </th>
                  <th className="text-left p-4 text-xs font-semibold text-[#101828] uppercase tracking-wider">
                  ...
                  <th className="text-left p-4 text-xs font-semibold text-[#101828] uppercase tracking-wider">Risk Ratio</th>
                  <th className="text-left p-4 text-xs font-semibold text-[#101828] uppercase tracking-wider">Call Provided Date</th>
                  <th className="text-left p-4 text-xs font-semibold text-[#101828] uppercase tracking-wider">More</th>
                </tr>
              </thead>
              <tbody>
                {clients.map((client, index) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-sm text-[#101828]">{client.calltype}</td>
                    ...
                    <td className="p-4 text-sm text-[#475467]">{client.stoploss}</td>
                    <td className="p-4 text-sm text-[#475467]">{client.riskratio}</td>
                       <td className="p-4 text-sm text-[#475467]">{client.callprovideddate}</td>
                    <td className="p-4">
                      <Button
                        variant="ghost"
                        size="icon"
